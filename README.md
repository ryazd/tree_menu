...
```
git clone https://github.com/ryazd/tree_menu.git
```
...
Оглавление
    ...
    Глава 2
```
9. При нажатии на `Глава 1` будет выведено:
```
Оглавление
    Глава 1
        Подглава 1.1
    ...
    Глава 2
```
10. При нажатии на `Глава 2` будет выведено:
```
Оглавление
    Глава 1
    Глава 2
